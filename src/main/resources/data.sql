...
VALUES (1, '대전유천DT', '대전광역시 중구 계백로1604(유천동)', '1522-3232', '07:00', '22:00', 3, true,
        'https://images.unsplash.com/photo-1601813913455-118810e79277?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'),
       (2, '대전대사DT', '대전광역시 중구 계룡로 949(대사동)', '1522-3232', '07:00', '22:00', 3, true,
        'https://images.unsplash.com/photo-1601813913455-118810e79277?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'),
       (3, '서대전네거리', '대전광역시 중구 계룡로 878(오류동), 1층', '1522-3232', '07:00', '22:00', 3, true,
        'https://images.unsplash.com/photo-1601813913455-118810e79277?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'),
       (4, '대전태평', '대전광역시 중구 태평로 71(태평동)', '1522-3232', '07:00', '22:00', 3, true,
        'https://images.unsplash.com/photo-1601813913455-118810e79277?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'),
       (5, '대전복수', '대전광역시 서구 복수남로 28(복수동)', '1522-3232', '07:00', '22:00', 3, true,
        'https://images.unsplash.com/photo-1601813913455-118810e79277?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'),
       (6, '대전목동DT', '대전광역시 중구 동서대로 1387(목동)', '1522-3232', '07:00', '22:00', 3, true,
        'https://images.unsplash.com/photo-1601813913455-118810e79277?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'),
       (7, '대전중앙로R', '대전광역시 중구 대종로486 (은행동)', '1522-3232', '07:00', '22:00', 3, true,
        'https://images.unsplash.com/photo-1601813913455-118810e79277?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'),
       (8, '은행동', '대전광역시 중구 중앙로164 (은행동)', '1522-3232', '07:00', '22:00', 3, true,
        'https://images.unsplash.com/photo-1601813913455-118810e79277?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');
ALTER TABLE stores
    AUTO_INCREMENT = 2;
...
VALUES (1, 1, 1),
       ...
       (28, 8, 3),
       (29, 8, 4);
ALTER TABLE store_pickup_options
    AUTO_INCREMENT = 5;
...
VALUES (1, '카페 아메리카노(HOT)', 'Caffe Americano(HOT)', '진한 에스프레소와 뜨거운 물을 섞어 스타벅스의 깔끔하고 강렬한 에스프레소를 가장 부드럽게 잘 느낄 수 있는 커피',
        4700,
        '아메리카노 이미지', 'BEVERAGE', 'BEVERAGE'),
       (2, '카페 아메리카노(ICE)', 'Caffe Americano(ICE)', '진한 에스프레소와 차가운 물을 섞어 스타벅스의 깔끔하고 강렬한 에스프레소를 가장 부드럽게 잘 느낄 수 있는 커피',
        4700,
        '아메리카노 이미지', 'BEVERAGE', 'BEVERAGE'),
