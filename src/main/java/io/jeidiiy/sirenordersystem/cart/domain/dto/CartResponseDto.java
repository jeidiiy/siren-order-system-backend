...
public record CartResponseDto(
    Integer cartId, Integer productId, Integer quantity, Integer price, String productKrName) {
  public static CartResponseDto fromEntity(Cart cart) {
    Product product = cart.getProduct();
    return new CartResponseDto(
        cart.getId(), product.getId(), cart.getQuantity(), cart.getPrice(), product.getKrName());
  }
}
